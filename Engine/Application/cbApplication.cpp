...
const uint16_t eae6320::Application::cbApplication::s_defaultInitialResolution_width = 512;
const uint16_t eae6320::Application::cbApplication::s_defaultInitialResolution_height = 512;
...
void eae6320::Application::cbApplication::UpdateUntilExit()
{
    ...
    while ( !m_shouldApplicationLoopExit )
    {
        ...
        uint64_t tickCount_toSimulate_elapsedSinceLastLoop;
        {
            ...
            {
                const auto tickCount_systemTime_previousLoop = m_tickCount_systemTime_current;
                m_tickCount_systemTime_current = Time::GetCurrentSystemTimeTickCount();
