...
namespace eae6320
{
    namespace Application
    {
        ...
        private:
            ...
            {
                o_width = s_defaultInitialResolution_width;
                o_height = s_defaultInitialResolution_height;
            }
        ...
        public:
            ...
            static const uint16_t s_defaultInitialResolution_width;
            static const uint16_t s_defaultInitialResolution_height;
